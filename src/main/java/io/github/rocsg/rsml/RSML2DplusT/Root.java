...
import io.github.rocsg.rsml.IRootModelParser;
import io.github.rocsg.rsml.IRootParser;
import io.github.rocsg.rsml.RSML2D.Annotation;
import io.github.rocsg.rsml.RSML2D.Function;
import io.github.rocsg.rsml.RSML2D.Geometry;
import io.github.rocsg.rsml.RSML2D.Property;
    ...
    public void updateTiming() {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (Math.round(tabNode[i].birthTime) == memory && (i != (N - 1))){
                tabExact[i] = false;
                // ICI Corriger bug extension racine
            }
