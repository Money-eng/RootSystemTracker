...
public class Mark {
    ...
    static {
        typeIcon[FREE_TEXT] = new Icon() {
            final int[] xPoints = {0, 0, 5};
            final int[] yPoints = {0, 10, 5};
        ...
        typeIcon[INTERVAL] = new Icon() {
            final int[] xPoints1 = {0, 0, 4, 4, 0, 0};
            final int[] yPoints1 = {0, 5, 0, 10, 5, 10};
            final int[] xPoints2 = {10, 10, 6, 6, 10, 10};
            final int[] yPoints2 = {0, 5, 0, 10, 5, 10};
        ...
        typeIcon[ANCHOR] = new Icon() {
            final int[] xPoints = {0, 0, 10, 10};
            final int[] yPoints = {0, 10, 0, 10};
        ...
        typeIcon[LENGTH] = new Icon() {
            final int[] xPoints = {0, 10};
            final int[] yPoints = {5, 5};
    ...
    static public Mark read(org.w3c.dom.Node parentDOM, Root r, boolean isForeign, String imgName, float dpiRatio) {  // XD 20110629
        ...
        while (nodeDOM != null) {
            ...
            } else if (nName.equalsIgnoreCase("lPos"))
                lPos = dpiRatio * Float.valueOf(nodeDOM.getFirstChild().getNodeValue()).floatValue();
            else if (nName.equalsIgnoreCase("twinLPos"))
                twinLPos = dpiRatio * Float.valueOf(nodeDOM.getFirstChild().getNodeValue()).floatValue();
     ...
     */
    public static boolean needsValue(int type) {
        return typeNeedsValue[type];
    }
     ...
     * @return true, if successful
     */
    public static boolean needsTwinPosition(int type) {
    ...
    public void saveRSML(FileWriter dataOut) throws IOException {
        ...
        dataOut.write("				    <lPos>" + lPos + "</lPos>" + nL);
        dataOut.write("				    <point x='" + xLabel + "' y='" + yLabel + "'/>" + nL);
     ...
     * @return true, if successful
     */
    public boolean needsTwinPosition() {
        return (type == INTERVAL);
    }
